...
export function CustomerListPage(props: CustomerListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'payment.count', 'troubleshoot.count', 'wifi_access.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('payment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('troubleshoot', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'troubleshoot',
          header: 'Troubleshoot',
          accessorKey: 'troubleshoot',
          cell: ({ row: { original: record } }: any) => record?._count?.troubleshoot,
        }
      : null,
    hasAccess('wifi_access', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'wifi_access',
          header: 'Wifi Access',
          accessorKey: 'wifi_access',
          cell: ({ row: { original: record } }: any) => record?._count?.wifi_access,
        }
      : null,
